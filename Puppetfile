...
mod 'CiscoSystems/openstack', :git => "git://github.com/#{openstack_module_account}/puppet-openstack", :ref => openstack_module_branch
mod 'CiscoSystems/quantum', :git => "git://github.com/#{openstack_module_account}/puppet-quantum", :ref => openstack_module_branch
#mod 'CiscoSystems/swift', :git => "git://github.com/#{openstack_module_account}/puppet-swift", :ref => openstack_module_branch_name
